// src/components/solana-all-in-one-booster/BannerAllInOne.tsx
"use client";
...
export default function BannerAllInOne() {
  ...
  return (
    <section className="py-2 bg-zinc-950 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <p className="text-amber-400/80 text-base md:text-lg font-semibold tracking-wider uppercase mb-5 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
          WORKS ON ALL MAJOR SOLANA DEXs &amp; LAUNCHPADS
        </p>
          ...
          >
            <div className="marquee-inner flex whitespace-nowrap gap-14">
              {platforms.map((platform, i) => (
                ...
                >
                  <div className="w-16 h-16 flex items-center justify-center bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl group-hover:border-amber-400/40 transition-all">
                    <Image
                      src={platform.logo}
                      alt={`${platform.name} – Solana All-in-One Booster supported`}
                      width={50}
                      height={50}
