// src/app/components/Header1.tsx
// REINER SERVER COMPONENT – maximaler Speed + schönes Aussehen
  ...
  return (
    <section id="header" className="relative bg-black py-2 md:py-5 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-cyan-600/10 rounded-full blur-3xl gentle-pulse" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-emerald-600/10 rounded-full blur-3xl gentle-pulse-reverse" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-2 md:px-3">
        <div className="max-w-5xl mx-auto bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl px-6 md:px-12 py-12 md:py-16 text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 mb-10">
            <Link href="/" className="shrink-0 order-2 md:order-1" aria-label="Solana Holder & Volume Bot Logo">
              <svg
