export default function Benefits() {
    const benefits = [
      {
        title: "Permanent Solana Holders",
        desc: "Boost your Solana token project long-term with permanent holders generated effortlessly.",
        icon: (
          <svg className="w-12 h-12 text-blue-400" fill="currentColor" viewBox="0 0 16 16">
      ...
      },
      {
        ...
        desc: "Get started quickly with rapid configuration and token distribution.",
        icon: (
          <svg className="w-12 h-12 text-blue-400" fill="currentColor" viewBox="0 0 16 16">
      ...
      {
        title: "Fully Automated Bot",
        desc: "Set it once and let our Telegram bot automate your holder generation.",
        icon: (
          <svg className="w-12 h-12 text-blue-400" fill="currentColor" viewBox="0 0 16 16">
      ...
      },
      {
        ...
        desc: "Choose the perfect plan tailored to your Solana memecoin needs.",
        icon: (
          <svg className="w-12 h-12 text-blue-400" fill="currentColor" viewBox="0 0 16 16">
      ...
      },
      {
        ...
        desc: "Built with advanced safety features for your peace of mind.",
        icon: (
          <svg className="w-12 h-12 text-blue-400" fill="currentColor" viewBox="0 0 16 16">
      ...
      },
      {
        ...
        desc: "Dependable performance trusted by memecoin creators worldwide.",
        icon: (
          <svg className="w-12 h-12 text-blue-400" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="group p-6 bg-gray-800 rounded-2xl border-4 border-gray-700 hover:border-blue-500 transition-all duration-300 shadow-lg hover:shadow-blue-500/30"
              >
