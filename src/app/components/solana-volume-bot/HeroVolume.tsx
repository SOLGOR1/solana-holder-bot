...
export default function HeroVolume() {
  return (
    <section className="relative min-h-[70dvh] flex flex-col items-center justify-center pt-4 pb-4 text-center">
      ...
      {/* Button – kleiner, heller, mit kontrolliertem Shine */}
      <Link
        href="https://t.me/leektradingbot"
        className="group relative mt-9 inline-flex items-center px-9 py-3 bg-gradient-to-r from-emerald-500 to-emerald-700 text-white font-semibold text-lg rounded-2xl shadow-[0_0_35px_#34d399] hover:shadow-[0_0_55px_#67e8f9] transition-all duration-300 hover:-translate-y-0.5 active:scale-95 overflow-hidden"
      >
        Launch Volume Bot
        {/* Kontrollierter Shine – bleibt 100 % im Button */}
