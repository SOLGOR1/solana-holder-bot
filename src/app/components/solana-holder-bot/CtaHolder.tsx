// src/components/solana-holder-bot/CtaHolder.tsx
"use client";

import { motion } from "framer-motion";

export default function CtaHolder() {
  return (
    <section className="py-16 md:py-20 relative z-10">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 mb-10 md:mb-12">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-100 max-w-xl">
              Start now and see what our Solana Holder Bot can do for your project.
            </p>
          </div>
        ...
        {/* Button – jetzt groß, cyan und zum richtigen Bot */}
        <div className="text-center">
          <motion.a
            ...
            className="
              ...
              hover:from-cyan-500 hover:via-cyan-400 hover:to-cyan-300
              hover:shadow-[0_15px_50px_rgba(34,211,238,0.5)]
              hover:-translate-y-1 active:scale-98
            "
            whileTap={{ scale: 0.98 }}
          >
            Launch Solana Holder Bot Now
          </motion.a>
        </div>
