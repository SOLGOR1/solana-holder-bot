...
## Why 2026 is a turning point {#why-2026}
...
## Firedancer: a second, independent validator client {#firedancer}
...
## Alpenglow: sub-150 ms finality and the end of on-chain votes {#alpenglow}
...
## Local fee markets: why Solana fees stay low {#fees}
...
## Throughput: how much can Solana actually process? {#throughput}
...
## How the upgrades fit together {#together}
